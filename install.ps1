# If any command throws an error, stop the script immediately
...
function Write-Part ($Part) { Write-Host -Object $Part -NoNewline }
function Write-Emphasized ($Emphasis) { Write-Host -Object $Emphasis -NoNewLine -ForegroundColor "Yellow" }
